    ...
    <%@ taglib uri="jakarta.tags.core" prefix="c" %>
        ...
        <body>
            <div class="container">
                            ...
                            <c:forEach var="todo" items="${todos}">
                                <div class="todo-item ${todo.completed ? 'completed' : ''}">
                                    ...
                                    <div class="todo-content">
                                        ...
                                        <div class="todo-meta">
                                            <span
                                                class="priority-badge priority-${todo.priority}">${todo.priority}</span>
                ...
                <!-- Footer -->
                <div class="footer">
                    <p>Todo List Saif &mdash; Built with Java Servlets</p>
                    <c:if test="${completedCount > 0}">
                        <form action="${pageContext.request.contextPath}/todos" method="post" style="margin-top: 8px;">
                            ...
                            <button type="submit" class="btn btn-danger btn-sm">Clear ${completedCount}
                                completed</button>
                        </form>
                    </c:if>
                </div>
